...
import 'package:mural_de_recados/aluno/bloc/login_bloc.dart';
import 'package:mural_de_recados/aluno/start_aluno.dart';
      ...
      switch (state) {
        case LoginState.SUCCESS:
          Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (context) => StartAluno()));
          break;
        case LoginState.FAIL:
          showDialog(
              ...
              builder: (context) => AlertDialog(
                    title: Text('Erro'),
                    content: Text('Você não é um usuário Aluno'),
                  ));
          break;
